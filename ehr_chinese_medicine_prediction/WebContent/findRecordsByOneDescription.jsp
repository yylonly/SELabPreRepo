...
<body>
	<div id="wrapper">
		...
		<div class="container-fluid">
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<h1 class="page-header">根据单一症状查找病历</h1>
            	</div>
            </div>
            <div class="col-sm-12">
	...
	<script type="text/javascript">
		function btn_query(){
			...
			$btn.bind("click",function(){
				...
				$.ajax({
	                type:"post",
	                url:"queryRecordByOneDescription",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
	                data:{//设置数据源
	                	batch:$('#batch').val(),
